        ...
        <script type="text/javascript">
            ...
            function curtir(idPostagem) {
                ...
                , function (receivedData, textStatus, jqXHR) {
                    ...
                    if (textStatus == 'success') {
                        $('#quadroCurtidasPost' + idPostagem).html('<div id=\"quadroCurtidasPost{{id}}\"><p>Curtidas: <label id=\"curtidasPost' + idPostagem + '\">' + receivedData.curtidas + '<\/label><\/p><button class="btnDescurtir" id=\"aDescurtir\" onclick=\"descurtir(' + idPostagem + ')\">Descurtir<\/button>');
                    }
                });

                var curtidaAtual = $('#curtidasPost' + idPostagem).html();
                $('#quadroCurtidasPost' + idPostagem).html('<div id=\"quadroCurtidasPost{{id}}\"><p>Curtidas: <label id=\"curtidasPost' + idPostagem + '\">' + (parseInt(curtidaAtual) + 1) + '<\/label><\/p><button class="btnDescurtir" id=\"aDescurtir\" onclick=\"descurtir(' + idPostagem + ')\">Descurtir<\/button>');
            }
            ...
            function descurtir(idPostagem) {
                ...
                , function (receivedData, textStatus, jqXHR) {
                    ...
                    if (textStatus == 'success') {
                        $('#quadroCurtidasPost' + idPostagem).html('<p>Curtidas: <label id=\"curtidasPost' + idPostagem + '\">' + receivedData.curtidas + '<\/label><\/p><button class="btnCurtir" id=\"aCurtir\" onclick=\"curtir(' + idPostagem + ')\">Curtir<\/button>');
                    }
                });

                var curtidaAtual = $('#curtidasPost' + idPostagem).html();
                $('#quadroCurtidasPost' + idPostagem).html('<p>Curtidas: <label id=\"curtidasPost' + idPostagem + '\">' + (parseInt(curtidaAtual) - 1) + '<\/label><\/p><button class="btnCurtir" id=\"aCurtir\" onclick=\"curtir(' + idPostagem + ')\">Curtir<\/button>');
